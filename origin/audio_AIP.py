...
RECORD_SECONDS = 5
# 要写入的文件名
WAVE_OUTPUT_FILENAME_1 = "C:/Users/pc/Desktop/program_edit/program/audio/output.wav"
# 读取文件
...
'''
# 识别本地文件
a = client.asr(get_file_content('C:/Users/pc/Desktop/program_edit/program/audio/output.wav'), 'pcm', 16000, {'dev_pid': 1536,})
if type(a)==dict:
    print(1)
print(a)
print(type(a.get('err_no')))
k=a.get('result')
