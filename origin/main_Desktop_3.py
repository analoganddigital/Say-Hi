...
def insert_point(): # 在鼠标焦点处插入输入内容
    ...
    if butt == False:
        ...
        print_desk.insert('insert', "get word chat: " + word_ch + "\n")
        print_desk.insert('insert', "you can print 'q' to close " + "\n")
        main_go = main_edit_2(PC_v, level_v, face_capture, audio_tran, view_v, IP_add, word_ch)
...
word = tk.Label(window, bg='white', width=18, text='Word Chatting:')
word.pack()
word.place(x=30,y=150)

word_1 = tk.Radiobutton(window, text='open', variable=word_var, value=1)
word_1.pack()
word_1.place(x=180,y=150)
word_2 = tk.Radiobutton(window, text='close', variable=word_var, value=0)
word_2.pack()
word_2.place(x=240,y=150)


view_var = tk.StringVar()
view = tk.Label(window, bg='white', width=10, text='Style:')
view.pack()
view.place(x=30,y=180)

view_1 = tk.Radiobutton(window, text='natural', variable=view_var, value=0)
view_1.pack()
view_1.place(x=180,y=180)
view_2 = tk.Radiobutton(window, text='cartoon', variable=view_var, value=1)
view_2.pack()
view_2.place(x=250,y=180)
view_3 = tk.Radiobutton(window, text='pencil', variable=view_var, value=2)
view_3.pack()
view_3.place(x=320,y=180)
