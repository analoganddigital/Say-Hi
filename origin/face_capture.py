# -*- coding: utf-8 -*-
"""
Created on Tue Apr  2 18:05:47 2019
            ...
            if(len(faces)!=0):
                ...
                for i in range(len(faces)):
                    ...
                    for k, d in enumerate(faces):
                        ...
                        mouth_width = (shape.part(54).x - shape.part(48).x) / self.face_width  # 嘴巴咧开程度，宽度
                        mouth_higth = (shape.part(66).y - shape.part(62).y) / self.face_width  # 嘴巴张开程度，高度
